...
def filter_price_data(mix_price_detail, gap_price=2, compare=">", plus_limit=None, minus_limit=-5, query_code=None):
...
def price_special_case_manager(merged_data, case=None, init_size=0):
    ...
    if case == "OldPriceMissing":
        ...
        if norma_size >= limit_size:
            ...
            null_data_list.fillna({"old_price": 0.0, "quantity": 3}, inplace=True)
