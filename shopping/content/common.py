...
# flags/arguments.
def init(argv, doc, parents=None, sandbox=False, store_name=None):
    ...
    if not flags.noconfig:
        ...
        # modify content_path
        content_path = os.path.join(argv[0], flags.config_path)
        content_path = os.path.join(content_path, 'content')
        content_path = os.path.join(content_path, store_name)
        # modify content_path
